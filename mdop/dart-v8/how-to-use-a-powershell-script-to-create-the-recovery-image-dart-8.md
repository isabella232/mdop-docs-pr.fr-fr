...
ms.locfileid: "10809624"
---
# <span data-ttu-id="9716e-103">Procédure d'utilisation d'un script PowerShell pour créer l'image de récupération</span><span class="sxs-lookup"><span data-stu-id="9716e-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="9716e-104">Pour créer l’image de récupération DaRT à l’aide d’un script PowerShell</span><span class="sxs-lookup"><span data-stu-id="9716e-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="9716e-105">Vous pouvez créer l’image de récupération d’outils de diagnostics et de récupération Microsoft (DaRT) 8,0 à l’aide d’un script PowerShell au lieu d’utiliser l’Assistant image de récupération 8,0.</span><span class="sxs-lookup"><span data-stu-id="9716e-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="9716e-106">Consultez l’exemple de script suivant.</span><span class="sxs-lookup"><span data-stu-id="9716e-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="9716e-107">Ma</span><span class="sxs-lookup"><span data-stu-id="9716e-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="9716e-108">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="9716e-108">Related topics</span></span>


[<span data-ttu-id="9716e-109">Administration de DaRT8.0 à l'aide de PowerShell</span><span class="sxs-lookup"><span data-stu-id="9716e-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
