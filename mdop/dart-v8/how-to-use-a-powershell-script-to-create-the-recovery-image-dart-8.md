...
Vous pouvez créer l’image de récupération d’outils de diagnostics et de récupération Microsoft (DaRT) 8,0 à l’aide d’un script PowerShell au lieu d’utiliser l’Assistant image de récupération 8,0. Consultez l’exemple de script suivant.
