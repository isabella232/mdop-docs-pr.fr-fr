...
Supprime tous les enregistrements de votre application.
...
<td align="left"><p>Si cette valeur est spécifiée, toutes les applications sont supprimées. Par défaut, seules les applications auxquelles l’utilisateur actuel a accès sont supprimées.</p></td>
</tr>
<tr class="even">
