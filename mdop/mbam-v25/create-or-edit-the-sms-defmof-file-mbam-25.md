...
Si vous utilisez SystemCenter2012 ConfigurationManager, vous devez créer le fichier. Créez le fichier sur le site de niveau supérieur. Les modifications seront répliquées sur les autres sites de votre infrastructure.
...
3.  Modifiez la classe **Win32 \ _Tpm** comme suit:
    ...
    Vous **avez une suggestion pour MBAM**? Ajoutez ou Votez en fonction [de suggestions.](http://mbam.uservoice.com/forums/268571-microsoft-bitlocker-administration-and-monitoring) Vous **avez un problème avec mbam**? Utiliser le [Forum TechNet MBAM](https://social.technet.microsoft.com/Forums/home?forum=mdopmbam).
