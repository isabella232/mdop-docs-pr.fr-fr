...
Pour permettre aux ordinateurs clients de signaler les détails de conformité BitLocker par le biais des rapports du gestionnaire de configuration MBAM, vous devez modifier le fichier **Configuration. mof** , que vous utilisiez le SystemCenter2012 ConfigurationManager ou configuration Manager 2007. Suivez les instructions ci-dessous pour la version de Configuration Manager que vous utilisez.
