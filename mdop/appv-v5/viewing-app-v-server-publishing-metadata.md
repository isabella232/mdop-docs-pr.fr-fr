...
-   [Configuration requise pour App-V 5,0 SP3 pour afficher les métadonnées de publication](#bkmk-50sp3-reqs-pub-meta)
...
## <a href="" id="bkmk-50sp3-reqs-pub-meta"></a>Configuration requise pour App-V 5,0 SP3 pour afficher les métadonnées de publication
...
<div class="alert">
<strong>Remarque</strong><br/><p><strong>ClientVersion </strong> et les <strong> clients </strong> y sont uniquement pris en charge dans App-V 5,0 SP3.</p>
</div>
<div>

</div></td>
<td align="left"><p>Voir les informations pour App-V 5,0 SP3.</p></td>
