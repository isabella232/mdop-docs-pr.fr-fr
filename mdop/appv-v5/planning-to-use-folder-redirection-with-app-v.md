...
App-V 5,0 SP2 prend en charge l’utilisation de la redirection de dossiers, une fonctionnalité qui permet aux utilisateurs et aux administrateurs de rediriger le chemin d’accès d’un dossier vers un nouvel emplacement.
...
<tr class="even">
<td align="left"><p>Dans App-V 5,0 SP3</p></td>
...
<p>Pour fournir la redondance, App-V 5,0 conserve les trois copies les plus récentes des données comprimées sous% AppData%.</p></td>
</tr>
</tbody>
</table>
