...
---
# <span data-ttu-id="a586d-103">Procédure d'utilisation d'un script PowerShell pour créer l'image de récupération</span><span class="sxs-lookup"><span data-stu-id="a586d-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="a586d-104">Pour créer l’image de récupération DaRT à l’aide d’un script PowerShell</span><span class="sxs-lookup"><span data-stu-id="a586d-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="a586d-105">Vous pouvez créer l’image de récupération du jeu d’outils de diagnostics et de récupération Microsoft (DaRT) 10 en utilisant un script PowerShell au lieu d’utiliser l’Assistant image de récupération de DaRT 10.</span><span class="sxs-lookup"><span data-stu-id="a586d-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="a586d-106">Consultez l’exemple de script suivant.</span><span class="sxs-lookup"><span data-stu-id="a586d-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="a586d-107">Ma</span><span class="sxs-lookup"><span data-stu-id="a586d-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="a586d-108">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="a586d-108">Related topics</span></span>


[<span data-ttu-id="a586d-109">Administration de DaRT10 à l'aide de PowerShell</span><span class="sxs-lookup"><span data-stu-id="a586d-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
